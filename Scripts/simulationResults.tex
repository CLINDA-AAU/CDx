%latex.default(resultsTable.tmp, title = "", rgroup = c("Weibull",     "log-normal", "log-logistic"), n.rgroup = c(2, 2, 2), colheads = c("Censoring",     "PPV", "Mean", "Coverage", "Mean", "Coverage"), cgroup = c("Simulation",     "Simon", "NonPar"), n.cgroup = c(2, 2, 2), rowlabel = NA,     file = "simulationResults.tex")%
\begin{table}[!tbp]
\begin{center}
